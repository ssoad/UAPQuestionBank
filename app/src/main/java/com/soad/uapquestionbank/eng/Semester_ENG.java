package com.soad.uapquestionbank.eng;
...
public class Semester_ENG extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ast_sem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonEffect(v);
                Intent in = new Intent(Semester_ENG.this, ViewQuestion_ENG_First.class);
                startActivity(in);
            }
        });
        ...
        bnd_sem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonEffect(v);
                Intent in = new Intent(Semester_ENG.this, ViewQuestion_ENG_Second.class);
                startActivity(in);
            }
        });
        ...
        crd_sem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonEffect(v);
                Intent in = new Intent(Semester_ENG.this, ViewQuestion_ENG_Third.class);
                startActivity(in);
            }
        });
        ...
        dth_sem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonEffect(v);
                Intent in = new Intent(Semester_ENG.this, ViewQuestion_ENG_Fourth.class);
                startActivity(in);
            }
        });
        ...
        eth_sem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonEffect(v);
                Intent in = new Intent(Semester_ENG.this, ViewQuestion_ENG_Fifth.class);
                startActivity(in);
            }
        });
        ...
        fth_sem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonEffect(v);
                Intent in = new Intent(Semester_ENG.this, ViewQuestion_ENG_Sixth.class);
                startActivity(in);
            }
        });
        ...
        gth_sem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonEffect(v);
                Intent in = new Intent(Semester_ENG.this, ViewQuestion_ENG_Seventh.class);
                startActivity(in);
            }
        });
        ...
        hth_sem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonEffect(v);
                Intent in = new Intent(Semester_ENG.this, ViewQuestion_ENG_Eighth.class);
                startActivity(in);
            }
        });
