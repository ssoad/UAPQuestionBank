package com.soad.uapquestionbank.dba;
...
public class Semester_DBA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dept.setText("Business Administration");
//
        ...
        ast_sem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonEffect(v);
                Intent in = new Intent(Semester_DBA.this, ViewQuestion_DBA_First.class);
                startActivity(in);
            }
        });
        ...
        bnd_sem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonEffect(v);
                Intent in = new Intent(Semester_DBA.this, ViewQuestion_DBA_Second.class);
                startActivity(in);
            }
        });
        ...
        crd_sem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonEffect(v);
                Intent in = new Intent(Semester_DBA.this, ViewQuestion_DBA_Third.class);
                startActivity(in);
            }
        });
        ...
        dth_sem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonEffect(v);
                Intent in = new Intent(Semester_DBA.this, ViewQuestion_DBA_Fourth.class);
                startActivity(in);
            }
        });
        ...
        eth_sem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonEffect(v);
                Intent in = new Intent(Semester_DBA.this, ViewQuestion_DBA_Fifth.class);
                startActivity(in);
            }
        });
        ...
        fth_sem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonEffect(v);
                Intent in = new Intent(Semester_DBA.this, ViewQuestion_DBA_Sixth.class);
                startActivity(in);
            }
        });
        ...
        gth_sem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonEffect(v);
                Intent in = new Intent(Semester_DBA.this, ViewQuestion_DBA_Seventh.class);
                startActivity(in);
            }
        });
        ...
        hth_sem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonEffect(v);
                Intent in = new Intent(Semester_DBA.this, ViewQuestion_DBA_Eighth.class);
                startActivity(in);
            }
        });
