...
public class ViewQuestion_EEE_Fourth extends AppCompatActivity {
    //the listview
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference(Constants.DATABASE_PATH_UPLOADS+"/EEE/2-2");
