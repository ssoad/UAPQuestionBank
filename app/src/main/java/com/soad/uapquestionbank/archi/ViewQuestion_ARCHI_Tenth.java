...
public class ViewQuestion_ARCHI_Tenth extends AppCompatActivity {
    //the listview
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sem_view.setText("Tenth Semester");
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference(Constants.DATABASE_PATH_UPLOADS+"/ARCHI/5-2");
