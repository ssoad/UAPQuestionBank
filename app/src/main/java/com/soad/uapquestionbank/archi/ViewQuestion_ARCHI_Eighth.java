...
public class ViewQuestion_ARCHI_Eighth extends AppCompatActivity {
    //the listview
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // String[] countryArray = {"India", "Pakistan", "USA", "UK"};
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference(Constants.DATABASE_PATH_UPLOADS+"/ARCHI/4-2");
