...
public class ViewQuestion_LAW_Second extends AppCompatActivity {
    //the listview
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference(Constants.DATABASE_PATH_UPLOADS+"/LAW/1-2");
