package com.soad.uapquestionbank.law;
...
public class Semester_LAW extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ast_sem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonEffect(v);
                Intent in = new Intent(Semester_LAW.this, ViewQuestion_LAW_First.class);
                startActivity(in);
            }
        });
        ...
        bnd_sem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonEffect(v);
                Intent in = new Intent(Semester_LAW.this, ViewQuestion_LAW_Second.class);
                startActivity(in);
            }
        });
        ...
        crd_sem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonEffect(v);
                Intent in = new Intent(Semester_LAW.this, ViewQuestion_LAW_Third.class);
                startActivity(in);
            }
        });
        ...
        dth_sem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonEffect(v);
                Intent in = new Intent(Semester_LAW.this, ViewQuestion_LAW_Fourth.class);
                startActivity(in);
            }
        });
        ...
        eth_sem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonEffect(v);
                Intent in = new Intent(Semester_LAW.this, ViewQuestion_LAW_Fifth.class);
                startActivity(in);
            }
        });
        ...
        fth_sem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonEffect(v);
                Intent in = new Intent(Semester_LAW.this, ViewQuestion_LAW_Sixth.class);
                startActivity(in);
            }
        });
        ...
        gth_sem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonEffect(v);
                Intent in = new Intent(Semester_LAW.this, ViewQuestion_LAW_Seventh.class);
                startActivity(in);
            }
        });
        ...
        hth_sem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonEffect(v);
                Intent in = new Intent(Semester_LAW.this, ViewQuestion_LAW_Eighth.class);
                startActivity(in);
            }
        });
